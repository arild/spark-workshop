...
libraryDependencies += "org.apache.spark" % "spark-streaming-twitter_2.11" % "1.3.1" exclude("org.eclipse.jetty", "jetty-server")

libraryDependencies += "org.apache.spark" % "spark-sql_2.11" % "1.3.1"
